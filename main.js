...
const upperFirst = __webpack_require__(/*! lodash.upperfirst */ "./node_modules/lodash.upperfirst/index.js");
...
module.exports = {
  render: (reactElement, scenegraph, callback) => {
    if (!SceneGraphInstance) {
      SceneGraphInstance = ReactReconcilerInst.createContainer(scenegraph, false);
    } // update the root Container


    return ReactReconcilerInst.updateContainer(reactElement, SceneGraphInstance, null, callback);
  }
};
...
const RedRectangle = props => React.createElement("rectangle", {
  width: props.width,
  height: props.height,
  fill: new Color("red"),
  x: 157,
...
const BlueEllipse = props => React.createElement("ellipse", {
  radiusX: props.radiusX,
  radiusY: props.radiusY,
  fill: new Color("blue")
});

const Shapes = () => React.createElement(React.Fragment, null, React.createElement(RedRectangle, {
  width: 100,
  height: 100
...
function createRectangle(selection) {
  ReactXD.render(React.createElement(Shapes, null), selection.insertionParent);
}
